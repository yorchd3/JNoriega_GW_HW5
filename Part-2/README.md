...
1. Inside your local git repository, create a directory for the assignment **Pymaceuticals**.

2. Add your Jupyter notebook to this folder. This will be the main script to run for analysis.
